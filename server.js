...
app.post('/webhook', async (req, res) => {
  ...
  switch (client.step) {
    case 'menu':
      switch (msg) {
        case '1':
          client.step = 'cabello_menu';
          twiml.message(submenuCabello());
          break;
        case '2':
          client.step = 'unas_menu';
          twiml.message(submenuUnas());
          break;
        case '3':
          twiml.message('📋 Lista de precios: https://example.com/servicios');
        ...
        case '5':
          twiml.message('🕒 Horarios: https://example.com/horarios');
          client.awaitingMenu = true;
          client.step = 'awaiting_menu';
          break;
        case '6':
          twiml.message('📍 Dirección: Cartago, El Guarco. Waze: https://waze.com/aaaaa');
          client.awaitingMenu = true;
          client.step = 'awaiting_menu';
          break;
        case '7':
          twiml.message('💳 Cuenta BAC: CRlflfkkfkfk\nEnvía el comprobante a WhatsApp 7229 7263.');
          client.awaitingMenu = true;
          client.step = 'awaiting_menu';
          break;
        case '8':
          twiml.message('📱 SINPE móvil: 7229 7263\nEnvía el comprobante con tu nombre y servicio.');
          client.awaitingMenu = true;
          client.step = 'awaiting_menu';
          break;
        default:
